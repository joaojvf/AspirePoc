...
namespace AspirePoc.Core.Helpers
{
    public static class DefaultEntities
    {
        ...
        public static readonly List<Book> DefaultBooks = [
            new() { Id = 1, Tittle = "It Ends with Us", AuthorName = "Colleen Hoover", CategoryId = 1, ReleaseDate = new DateTime(2016,01,01),Description = "It Ends with Us is a romance novel by Colleen Hoover, published by Atria Books on August 2, 2016. Based on the relationship between her mother and father, Hoover described it as 'the hardest book I've ever written'",  },
